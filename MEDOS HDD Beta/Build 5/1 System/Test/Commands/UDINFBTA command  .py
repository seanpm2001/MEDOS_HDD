...
print ("Command size: 17297 bytes (16.8 Kilobytes)")
print ("Total lines of code used: 251")
...
if in1 == ("UDINFBTA"):
	...
	print ("==================================================================")
	print ("Version 1.0.03 Build 4A")
	print ("Another big update this time")
	print ("We added in a lot of system files, which is really increasing the space, be prepared for another B version")
	print ("Python 3.6.4 install files have been placed in SYSTEM8 for easy reinstall, or first install")
	print ("The system does not work properly without python-compatible software installed")
	print ("New plans:")
	print ("Making a Python 2.3 Port")
	print ("Making a Python 2.7 Port")
	print ("Making a Python 1.6 port")
	print ("Making s C+ port")
	print ("Making an ASSEMBLY port")
	print ("======================================================")
	print ("New in this update")
	print ("New screensaver added: DNA Farm, An endless DNA string")
	print ("New program: SYSBOOT5: This program is another attempt of compiling all the commands together into one program")
	print ("We have been experimenting with this since Version 1, but haven't been successful. This time, we have put more effort")
	print ("Into the port, and we are starting with commands and programs that are already finished, or extremely easy to modify")
	print ("once compiled. ")
	print ("The file is over 105 Kilobytes in size, and contains a lot of commands, but not one of the most important ones: help")
	print ("======================================================")
	print ("Updated some programs")
	print ("We updated the following programs")
	print ("BLISSCII preview (new) take a quick look at a command-line wallpaper imitating the famous Windows XP 'bliss'") 
	print ("UDINFBTA - Standard update to include new update info")
	print ("MCXRUN - Updated previous MacOS titles, and added support for the new MacOS 10.14 Mojave")
	print ("UBURUN - Stability and informative modifications")
	print ("======================================================")
	print ("Some new test files, such as:")
	print ("Test.py")
	print ("Testconfirm.py")
	print ("======================================================")
	print ("Modifications to commands")
	print ("Changed the format of the COMPBLOG command")
	print ("added porting information to the help command")
	print ("======================================================")
	print ("Some new important commands")
	print ("SYSSETS = Change system settings")
	print ("TLDINF = Learn more about Top Level Domains like .com .net .org ")
	print ("SYSFAQ = A frequently asked questions page for the operating system")
	print ("======================================================")
	print ("What you can now do with the SYSSETS command")
	print ("Nothing can be changed yet, this is an early beta version")
	print ("View the: ")
	print ("<>System resolution")
	print ("<>Aspect ratio")
	print ("<>font size")
	print ("<>font type")
	print ("<>color mode")
	print ("<>system Integer (32 bit)")
	print ("<>compatibility mode")
	print ("<>System language (Python(")
	print ("<>Device type")
	print ("<>File compatibility")
	print ("<>System security level")
	print ("<>Read, write and transfer speed for the drive, and network connection")
	print ("<>Connection speed")
	print ("<>Connection type")
	print ("<>Web connection (HTTPS, HTTP, WWW)")
	print ("==================================================================")
	print ("Extras:")
	print ("Added the CMNDTEST command, a command that lets you test commands (command-ception)")
	print ("A directory info file for the System folder")
	print ("==================================================================")
	print ("Version 1.0.05 Build 5A")
	print ("Codename: Binary Beach")
	print ("The Solid State update")
	print ("--------------------------------------------------")
	print ("So after a little research, I found out that Solid State Drives/Disks CAN be used for archival purposes, but just aren't the best option at the moment due to the price")
	print ("We will get ready for it early, and wait for the price to drop")
	print ("Remember how back in the 1980s, the capacity of technology doubled every 2 years, like 1 MB --> 2 MB | 2 MB --> 4 MB | and so-on")
	print ("It has been like that for a long time, but it isn't as noticeable anymore")
	print ("However, I made the error of writing that SSD's weren't a good idea many times during development, please ignore those, I do poor research at times")
	print ("===================================================")
	print ("This is another big update, as it is the first version to have a fully-optimized SDK (Software Development Kit) as the beta has gotten really far, and is almost ready to be fully ported as an Operating System. The system is getting ready and even has a codename now! For A versions, it will be codenamed: Binary Beach | for B versions, it will be codenamed: Binary Bay")
	print ("We are running out of features, and compatibility options to put in, so we have to get the SDK copies out to developers so we can get this around the world, highly stable, secure and strong. Updates will last a VERY long time after the system is released, but they will be security, and stability/patch updates")
	print ("This time, we added in some new features:")
	print ("<>Extras: Added new media files for our first and second MEDOS Commercials")
	print ("<>Main: Added a file that shows you EVERYTHING on the system, all file names locations, and sizes")
	print ("<>System12: Added some new files for definitions and testing. The Googolplex file shows an entire googolplex through an integer, which will crash. If you want to see a full Googolplex, go for the googolplex (fixed) version")
	print ("The File Formats definiton is a system file which can't be launched to see whats inside, but can be edited through 3rd party software like Microsoft Notepad, Notepad++, Visual Studio and more")
	print ("The MEMGUIDE file is another locked file like above, but instead of defining file formats, it defines system memory. It isn't functional yet, just like the previous file")
	print ("We also did some new standard updates")
	print ("<>Updated the UDINFBTA command")
	print ("==================================================================")
	print ("Version 1.0.05 Build 5B")
	print ("Codename: Binary Bay")
	print ("The Solid State update part B")
	print ("Minor update that gets rid of extra media files to reduce size")
	print ("Removed:")
	print ("<>MEDOS commercials")
	print ("<>System sounds")
	print ("<>Python Install files")
	print ("<>Audacity Install files")
	print ("--------------------------------------------------")
