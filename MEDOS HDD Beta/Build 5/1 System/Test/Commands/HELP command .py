...
print ("Command size: 12040 bytes (11.70 Kilobytes)")
print ("Total lines of code used: 176")
...
if in1 == ("help"):
	...
	print ("TLDINF = A command that tells you about Top Level Domains like .com .net .org and more")
	print ("SYSFAQ = A command that tells you frequently asked questions about rhe MEDOS operating system")
	print ("CMNDTEST = A command that lets you test other commands safely ")
	print ("============")
	print ("Session")
	...
	print ("DNAFARM = A screensaver of an endless DNA strand")
	print ("==============")
	print ("Integers")
	...
	print ("==============")
	print ("Kernel Commands")
	print ("Editing commands: 0")
	print ("Navigation commands: 2")
	print ("Session commands: 0")
	print ("File & program commands: 0")
	print ("External media commands: 0")
	print ("System setting commands: 9")
	print ("Screensaver commands: 4")
	print ("Integer commands: 5")
	print ("Debug commands: 0")
	print ("Total command count: 20")
	print ("===============")
	print ("Editing")
	print ("No commands available to edit within the kernel")
	print ("================")
	print ("Navigation")
	print ("BGUIDE = Byte guide - current progress: porting/stabilizing/compiling")
	print ("KBRDTEST = Keyboard testing - current progress: porting/stabilizing/compiling")
	print ("================")
	print ("Session")
	print ("No commands available to modify the current session")
	print ("================")
	print ("Files and programs")
	print ("No commands available to modify files & programs")
	print ("================")
	print ("External media")
	print ("No commands available to work with external media")
	print ("================")
	print ("System settings")
	print ("9XRUN = Change compatibility settings for Windows 9x operating systems (Windows NT 4, Windows 95, Windows 98, Windows ME) - current progress: porting/stabilizing/compiling")
	print ("XPRUN = Change compatibility settings for Windows XP and Server 2003 - current progress: porting/stabilizing/compiling")
	print ("3.RUN = Change the compatibility for Windows 3X based operating systems - current progress: porting/stabilizing/compiling")
	print ("MASYSRUN = Change the compatibility settings for Mac System 1-9 operating systems - current progress: porting/stabilizing/compiling")
	print ("MCXRUN = Change the compatibility settings for Mac OS X based operating systems - current progress: porting/stabilizing/compiling")
	print ("UBURUN = Change the compatibility settings for Debian and Ubuntu based operating systems - current progress: porting/stabilizing/compiling")
	print ("V7RUN = Change the compatibility settings for Windows Vista and Windows 7 operating systems - current progress: porting/stabilizing/compiling")
	print ("IORUN = Change the compatibility settings for iOS operating systems - current progress: porting/stabilizing/compiling")
	print ("ANDRORUN = Change the compatibility settings for Android operating systems - current progress: porting/stabilizing/compiling")
	print ("=================")
	print ("Screensavers")
	print ("PINEFALL = A screensaver of an ASCII pine tree growing or shrinking, you choose - current progress: porting/stabilizing/compiling")
	print ("7NATIONARMYBINARY = A screensaver of an entire song that was converted to binary that will scroll endlessly... or until you force-stop it - current progress: porting/stabilizing/compiling")
	print ("PLATFORMERSSKY = A screensaver of a massive endless platform - current progress: porting/stabilizing/compiling")
	print ("DNAFARM = A screensaver of an endless DNA strand - current progress: porting/stabilizing/compiling")
	print ("==================")
	print ("INTCOMP = A compatibility log for integer testing, designed to list compatibility for 8, 16, 32, and 64 bit devices - current progress: porting/stabilizing/compiling")
	print ("8BITEST1X = A command that counts from 0 to 256 by ones, the max value for an 8 bit integer, for stress testing purposes - current progress: porting/stabilizing/compiling")
	print ("16BITEST1X = A command that counts from 0 to 65,536 by ones, the max value for an 16 bit integer, for stress testing purposes - current progress: porting/stabilizing/compiling")
	print ("32BITEST1X = A command that counts from 0 to 2,147,483,647 by ones, the max value for an 32 bit integer, for stress testing purposes - current progress: porting/stabilizing/compiling")
	print ("64BITEST1X = A command that counts from 0 to 9,223,372,036,854,775,807 by ones, the max value for an 64 bit integer, for stress testing purposes - current progress: porting/stabilizing/compiling")
	print ("64BITEST1000X = A command that counts from 0 to 9,223,372,036,854,775,807, however it is counting by the thousand, and will not come to an exact number, which causes a future crash after several hours of runtime the max value for an 64 bit integer, for stress testing purposes - current progress: porting/stabilizing/compiling")
	print ("===================")
	print ("DEBUG")
	print ("There are currently no commands available to debug the kernel")
	print ("====================")
	print ("We are currently ongoing our fifth attempt at compiling all working commands into the kernel, however it is really unstable at the moment")
	print ("Through the recent 4 builds of the system, we have gained a lot of experience with how the Meadows BASIC kernel works, and it is still growing")
	print ("We are going to keep attempting this, this is our best attempt at the all-together kernel")
	print ("You may have noticed that there aren't as many commands for it, that is because we are using only the most complete commands that require the least amount of modification")
	print ("It is our way of sorting it and working it out")
	print ("*****")
