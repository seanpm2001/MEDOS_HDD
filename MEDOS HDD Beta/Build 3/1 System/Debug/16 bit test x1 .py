count = int
in1 = str
print ("Opening debug tool: 16 bit count")
print ("This command tests your system to see if it can count to an 16 bit integer of 65536")
print ("{system} file selected: 16BITTESTX1.PY")
print ("Ready to launch!")
print ("Estimated time:")
print ("8 MB RAM = 2300 seconds:")
